...
export function StageGate({ targetStage, position }: StageGateProps) {
    ...
    const startEndingVideo = useGameStore(s => s.startEndingVideo);
    ...
    }, [isInteractive, isUnlocked, stageCleared, nextStage, setInteractionPrompt, isFinalGate, startEndingVideo]);
